...
public class IDCardResult extends ResponseResult {
    ...
    public String toString() {
        if (TextUtils.isEmpty(this.idCardSide)) {
            ...
            return "IDCardResult front{direction=" + this.direction + ", wordsResultNumber=" + this.wordsResultNumber + ", address=" + this.address + ", idNumber=" + this.idNumber + ", birthday=" + this.birthday + ", name=" + this.name + ", gender=" + this.gender + ", ethnic=" + this.ethnic + ", RiskType=" + this.riskType + '}';
        } else {
