...
public class ViewPrinterProvider {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = dp2px(100f, rootView.getResources());
        params.rightMargin = dp2px(16f, rootView.getResources());
    ...
    private void showLogView() {
        if(rootView.findViewWithTag(TAG_LOG_VIEW) != null)
            return;
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dp2px(160f,rootView.getResources()));
